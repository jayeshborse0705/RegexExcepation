    ...
    public class Validation
    {
        ...
        public string Validate_PassWord(string passWord)
        {
            try
            {
                ...
                {
                    throw new RegexCustomExpection(RegexCustomExpection.Exceptiontype.PASSWORD1_INVALID, "Password is invalid");
                }
            }
            catch
            {
        ...
        public string Validate_PassWord2(string passWord2)
        {
            try
            {
                ...
                {
                    throw new RegexCustomExpection(RegexCustomExpection.Exceptiontype.PASSWORD2_INVALID, "Password is invalid");
                }
            }
            catch
            {
        ...
        public string Validate_PassWord3(string passWord3)
        {
            try
            {
                ...
                {
                    throw new RegexCustomExpection(RegexCustomExpection.Exceptiontype.PASSWORD3_INVALID, "Password is invalid");
                }
            }
            catch
            {
        ...
        public string Validate_PassWord4(string passWord4)
        {
            try
            {
                ...
                {
                    throw new RegexCustomExpection(RegexCustomExpection.Exceptiontype.PASSWORD4_INVALID, "Password is invalid");
                }
            }
            catch
            {
